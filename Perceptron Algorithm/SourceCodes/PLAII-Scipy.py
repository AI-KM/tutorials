...
if noOfArguments==1:
    ...
    print("No argument input or arguments mismatch error. train.txt will be used default !!!"); filename="train.txt"
...
PerceptronX= Perceptron(tol=1e-3, random_state=0)
#PerceptronX.train(trainingInputs, trainingLabels)
print("Trainings....")
PerceptronX.fit(trainingInputs, trainingLabels)  
Perceptron(alpha=0.0001, class_weight=None, early_stopping=False, eta0=1.0,
      fit_intercept=True, max_iter=1000, n_iter_no_change=5, n_jobs=None,
      penalty=None, random_state=0, shuffle=False, tol=0.0,
      validation_fraction=0.0001, verbose=2, warm_start=False)
PerceptronX.score(trainingInputs, trainingLabels)  
